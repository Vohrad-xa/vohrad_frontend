...
type NativeSecureFieldProps = Omit<
  SecureFieldProps,
...
const SecureFieldNativeView: React.ComponentType<NativeSecureFieldProps> =
  requireNativeView('SykamoreUi', 'SecureFieldView');

function transformSecureFieldProps(
  props: SecureFieldProps,
): NativeSecureFieldProps {
