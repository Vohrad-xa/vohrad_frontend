...
const RectangleNativeView: React.ComponentType<RectangleProps> =
  requireNativeView('SykamoreUi', 'RectangleView');
...
const UnevenRoundedRectangleNativeView: React.ComponentType<UnevenRoundedRectangleProps> =
  requireNativeView('SykamoreUi', 'UnevenRoundedRectangleView');
